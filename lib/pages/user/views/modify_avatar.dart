...
class ModifyAvatar extends StatefulWidget {
  @override
  _ModifyAvatarState createState() => _ModifyAvatarState();
}
...
class _ModifyAvatarState extends State<ModifyAvatar> {
  ...
  Future getImage() async {
    ...
    setState((){
      ...
      print(image.path);
      _userBloc.modifyAvatarR(GetInfo.userShow.userId, image);
      _userBloc.findUserInfoRE(GetInfo.userShow.userEmail);
      GetInfo.needRefresh =true;
...
//            child: Image.network(Api.BaseUrl_com+
